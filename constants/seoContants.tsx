...
export const SITE_NAME = "Vaxtengen Systems Limited";
export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL || "https://vaxtengen.com"; // Update with actual URL
export const TWITTER_HANDLE = "@vaxtengen";
...
export const SEODATA: Record<string, SEOConfig> = {
  default: {
    ...
    description:
      "Vaxtengen Systems Limited  Ltd provides cutting-edge software development, AI integration, and digital transformation strategies to scale modern enterprises.",
    keywords: [
      "Vaxtengen Systems Limited",
  ...
  home: {
    ...
    description:
      "Innovate and grow with Vaxtengen Systems Limited. We build high-performance digital products, from mobile apps to enterprise AI systems, tailored to your business needs.",
    keywords: [
  ...
  login: {
    ...
    description:
      "Access your Vaxtengen Systems Limited client dashboard to track project progress, manage subscriptions, and collaborate with your dev team.",
    keywords: [
      "Client login",
      "Project tracking portal",
      "Vaxtengen Systems Limited dashboard access",
    ],
  },
  register: {
    title: `Partner with Us | Join ${SITE_NAME}`,
    description:
      "Create an account to start your project journey with Vaxtengen Systems Limited  and access premium tech resources.",
    keywords: [
      "Get started with Vaxtengen Systems Limited",
      "Project onboarding",
      "Digital partnership",
    ],
  },
