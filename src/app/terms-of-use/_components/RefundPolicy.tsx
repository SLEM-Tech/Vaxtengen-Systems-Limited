...
const RefundPolicy = () => {
  ...
  return (
    <div className="text-gray-600 space-y-6 text-xs sm:text-sm">
      <p>
        At Vaxtengen Systems Limited , we strive for 100% accuracy in every
      ...
      <section>
        ...
        <ul className="list-disc pl-5 mt-2 space-y-2">
          ...
          <li>
            ...
            our error, Vaxtengen Systems Limited Import covers the return
      ...
      <section>
        ...
        <p>
          At Vaxtengen Systems Limited Import, we act as your dedicated
