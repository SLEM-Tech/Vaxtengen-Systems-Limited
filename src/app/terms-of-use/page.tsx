            ...
            <div id="termsOfUse" className="text-gray-600 space-y-6">
              <div>
                ...
                <p className="mt-3 leading-[1.8] text-xs md:text-sm xl:text-base">
                  By accessing the Vaxtengen Systems Limited platform and
              ...
              <ul className="list-none space-y-5 text-xs md:text-sm xl:text-base">
                <li>
                  ...
                  Vaxtengen Systems Limited operates on a two-phase payment
                ...
                <li>
                  ...
                  7-14 days; Sea: 45-60 days) are estimates. Vaxtengen Systems
                ...
                <li>
                  ...
                  market volatility. Vaxtengen Systems Limited Digital
                  Innovations reserves the right to adjust invoices if there is
                  a significant shift in the exchange rate between the time of
                  order placement and the time of actual procurement.
                </li>
                ...
                <li>
                  ...
                  list. Vaxtengen Systems Limited reserves the right to cancel
              ...
              <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 mt-6">
                <p className="leading-[1.6] text-xs md:text-sm italic">
                  ...
                  Vaxtengen Systems Limited acts as a procurement and logistics
          ...
          {activeTab === "privacyPolicy" && (
            <div id="privacyPolicy" className="text-slate-600 space-y-8">
              ...
              <div>
                ...
                <p className="mt-3 leading-[1.8] text-xs md:text-sm xl:text-base">
                  Vaxtengen Systems Limited collects personal information to
                ...
                <ul className="mt-4 space-y-3 text-xs md:text-sm xl:text-base list-none pl-0">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      protect the Vaxtengen Systems Limited ecosystem.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1.5 size-1.5 rounded-full bg-primary-100 shrink-0" />
              ...
              <div className="bg-slate-900 text-white p-8 rounded-[2.5rem] shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="mt-4 leading-[1.8] text-xs md:text-sm xl:text-base opacity-80">
                    Vaxtengen Systems Limited employs bank-grade AES-256
              ...
              <div>
                ...
                <p className="mt-2 leading-[1.8] text-xs md:text-sm xl:text-base">
                  ...
                  <a
                    href="mailto:support@Vaxtengen Systems Limited.com"
                    className="text-primary-100 font-bold ml-1 hover:underline">
                    privacy@Vaxtengen Systems Limited.com
                  </a>
                  .
                </p>
              </div>
