			...
			<div className='flex flex-wrap gap-3 mb-3'>
				...
				{value.length < maxImages && (
					<button
						...
						disabled={uploading}
						className='w-24 h-24 rounded-lg border-2 border-dashed border-gray-300 flex flex-col items-center justify-center text-gray-400 hover:border-primary-100 hover:text-primary-100 transition-colors disabled:opacity-50'
					>
						{uploading ? (
