# vaxtengen Technologies — Developer Playbook
...
```bash
git clone https://github.com/SLEM-Tech/vaxtengen-technologies.git
cd vaxtengen-technologies
...
Creates all database tables with the `vaxtengen_` prefix. Source file: `src/lib/schema.sql`.

Tables created:

- `vaxtengen_users`
- `vaxtengen_categories`
- `vaxtengen_products`
- `vaxtengen_product_images`
- `vaxtengen_product_categories`
- `vaxtengen_product_attributes`
- `vaxtengen_orders`
- `vaxtengen_order_items`
- `vaxtengen_banners`
- `vaxtengen_global_settings`
...
```
GET http://localhost:3000/api/admin/bootstrap?secret=vaxtengen-admin-2024
```
...
curl "http://localhost:3000/api/admin/bootstrap?secret=vaxtengen-admin-2024"
```
...
| `http://localhost:3000/api/admin/bootstrap?secret=vaxtengen-admin-2024` | Create super admin account (step 3)        |
